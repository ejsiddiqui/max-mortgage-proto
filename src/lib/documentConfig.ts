...
export const DOCUMENT_CONFIG: DocSlot[] = [
...
export const DOCUMENT_SECTIONS = [
  { id: "borrower", label: "Section A — Borrower Documents" },
  { id: "company", label: "Section B — Company Documents", selfEmployedOnly: true },
  { id: "asset", label: "Section C — Asset Documents" },
  { id: "bank", label: "Section D — Banking Documents" },
  { id: "lease", label: "Section E — Lease of Target Asset" },
  { id: "other", label: "Section F — Others" },
];

export const getDocSlotsForBorrowerType = (borrowerType: "salaried" | "self_employed") => {
